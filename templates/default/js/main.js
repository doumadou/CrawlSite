...
return out;}
function gosubmit(form){value=form.key.value;var url='/search/'+ value;window.location=url;return false}
function go(a,b,c){var url='/search-'+ a+'-'+ b+'-'+ c+'.html';window.location.href=url}
